// sw.js — ProductionPOS offline app-shell cache
//
...
const CACHE_NAME = 'production-pos-shell-v62';
...
async function cacheShell(cache) {
  ...
  if (failed.length) {
    console.warn('[ProductionPOS] These shell assets could not be cached:', failed);
  }
}
