// sw.js — Hotel/Restaurant/Bar POS offline app-shell cache
//
...
const CACHE_NAME = 'servicespos-shell-v18';
...
async function cacheShell(cache) {
  ...
  if (failed.length) {
    console.warn('[HRB-POS] These shell assets could not be cached:', failed);
  }
}
