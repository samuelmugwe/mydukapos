// sw.js — School Fees Management offline app-shell cache
//
...
const CACHE_NAME = 'school-fees-shell-v49';
...
async function cacheShell(cache) {
  ...
  if (failed.length) {
    console.warn('[School Fees] These shell assets could not be cached:', failed);
  }
}
