// sw.js — MinimartPOS offline app-shell cache
//
...
const CACHE_NAME = 'owner-console-shell-v39';
...
async function cacheShell(cache) {
  ...
  if (failed.length) {
    console.warn('[MinimartPOS] These shell assets could not be cached:', failed);
  }
}
